...
def generate_ref_oad_nl_and_type(each_comb, ontology, deuterium):
    ...
    Args:
        each_comb (tuple): tuple data of C=C positions
...
def query_essential_diagnostic_ions(df, ref_oad_dict, db_in_SPB,
    ...
    Args:
        ...
        db_in_SPB (bool): Whether there is unsaturation in sphingoid base
...
def calc_presence_ratios_and_score(ref_oad_dict, cut_df, ref_precursor_mz, 
    ...
    Args:
        ...
        ms_tol_ppm (int): mass tolerance threshold based on ppm
        sph_set (list): [db_in_sphingobase, carbon number in sphingoid base]

    Returns:
        score_dict (dict): dict contains belows
...
def set_oad_graph_dict_value(oad_dict, lipid_info, auto_magnification):
    ...
    Args:
        ...
        auto_magnification (int): Automated defined magnification for OAD-MS/MS spectrum
